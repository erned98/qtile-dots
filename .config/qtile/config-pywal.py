...
colors = []
cache='/home/erne/.cache/wal/colors'
...
keys = [
    ...
    # change wallpaper
    Key([mod, "control"], "w", home + 'Scripts/btwos-wallpaper'),
...
# variables
var_bg_color = colors[0]
var_active_bg_color = 'ffffff'
var_active_fg_color = colors[0]
var_inactive_bg_color = colors[0]
var_inactive_fg_color = 'ffffff'
var_urgent_bg_color = colors[1]
var_urgent_fg_color = 'ffffff'
var_section_fg_color = colors[3]
var_active_color = 'ffffff'
var_normal_color = colors[0]
var_border_width = 3
var_margin = [6,6,6,6]
var_gap_top = 5
var_gap_bottom = 5
