...
keys = [
    ...
    Key([mod], "equal", lazy.layout.increase_ratio()),                              # increase master window size
    Key([mod], "minus", lazy.layout.decrease_ratio()),                              # decrease master window size
...
groups = [
        ...
        Group("2", label="2", layout="monadtall", matches=[Match(wm_class="qutebrowser"), Match(wm_class="web"), Match(wm_class="librewolf"), Match(wm_class="firefox")]),
        Group("3", label="3", layout="max", matches=[Match(wm_class="Gimp"), Match(wm_class="feh")]), 
