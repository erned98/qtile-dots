...
## Type: String
c.hints.border = '1px solid #dbdee6'
...
## Type: Padding
c.tabs.indicator.padding = {'top': 1, 'bottom': 1, 'left': 3, 'right': 6}
...
## qutebrowser`.
## Type: Dict
c.url.searchengines = {'DEFAULT':'https://www.qwant.com/?q={}', 'sp':'https://www.startpage.com/sp/search?query={}', 'ddg': 'https://duckduckgo.com/?q={}', 'yt': 'https://www.youtube.com/results?search_query={}', 'aw': 'https://wiki.archlinux.org/index.php?title=Special%3ASearch&fulltext=1&search={}'}
...
config.bind('aV', 'hint links spawn mpv --no-video {hint-url}')
...
config.set('content.user_stylesheets', '~/.config/qutebrowser/grayscale.css')

# ...but let come back in need
config.bind('gr', "set content.user_stylesheets ~/.config/qutebrowser/grayscale.css")
config.bind('gc', "set content.user_stylesheets ~/.config/qutebrowser/nocolor.css")
