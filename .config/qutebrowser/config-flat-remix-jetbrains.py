...
## qutebrowser`.
## Type: Dict
c.url.searchengines = {'DEFAULT':'https://www.startpage.com/sp/search?query={}', 'ddg': 'https://duckduckgo.com/?q={}', 'yt': 'https://www.youtube.com/results?search_query={}', 'aw': 'https://wiki.archlinux.org/index.php?title=Special%3ASearch&fulltext=1&search={}'}
