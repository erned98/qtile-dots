...
## Type: Int
c.colors.webpage.darkmode.threshold.background = 192
...
## Type: Font
c.fonts.tooltip = 'IosevkaTerm Nerd Font'
...
## Type: Padding
c.tabs.indicator.padding = {'top': 1, 'bottom': 1, 'left': 4, 'right': 4}
...
## qutebrowser`.
## Type: Dict
c.url.searchengines = {'DEFAULT':'https://www.qwant.com/?q={}', 'sp':'https://www.startpage.com/sp/search?query={}', 'ddg': 'https://duckduckgo.com/?q={}', 'yt': 'https://www.youtube.com/results?search_query={}', 'aw': 'https://wiki.archlinux.org/index.php?title=Special%3ASearch&fulltext=1&search={}', 'pkg': 'https://archlinux.org/packages/?sort=&q={}&maintainer=&flagged=', 'aur': 'https://aur.archlinux.org/packages?O=0&K={}'}
...
## Type: List of Perc
c.zoom.levels = ['25%', '33%', '50%', '67%', '75%', '90%', '100%', '110%', '115%', '125%', '150%', '175%', '200%', '250%', '300%', '400%', '500%']
...
c.colors.contextmenu.selected.bg = base06
...
# Binding to launch mpv for Youtube
config.bind('V', 'hint links spawn mpv {hint-url}')
config.bind('aV', 'hint links spawn kitty -e mpv --no-video {hint-url}')

# Binding to launch Bitwarden CLI
# config.bind('zl', 'spawn --userscript bw-dmenu-fill')
# config.bind('<z><l>', 'spawn --userscript qute-pass')
# config.bind('<z><u><l>', 'spawn --userscript qute-pass --username-only')
# config.bind('<z><p><l>', 'spawn --userscript qute-pass --password-only')
# config.bind('<z><o><l>', 'spawn --userscript qute-pass --otp-only')
config.bind('zl', 'spawn kitty --class=kitty-float /home/erne/Scripts/bitpass.sh {url:domain}')

# FOR FUCK'S DISCORD SAKE
config.set('content.cookies.accept', 'all', 'https://discord.com')
config.set('content.cookies.accept', 'all', 'https://discordapp.com')
config.set('content.local_storage', True, 'https://discord.com')
config.set('content.persistent_storage', True, 'https://discord.com')
